...
var PopperContent = function (_React$Component) {
  ...
  createClass(PopperContent, [{
    ...
    value: function render() {
      ...
      if (this.props.isOpen) {
        return this.props.container === 'inline' ? this.renderChildren() : ReactDOM.createPortal(React.createElement(
          'div',
          { ref: this.getRef },
          this.renderChildren()
...
var Table = function Table(props) {
  ...
  var table = React.createElement(Tag, _extends({}, attributes, { ref: innerRef, className: classes }));
